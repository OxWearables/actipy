...
def test_read_device():
    ...
    data_ref = pd.read_csv(io.StringIO(
        ...
        '2023-06-08 15:19:33.898,  0.375000,  -0.765625, -0.218750,  19.85\n'
        '2023-06-08 15:19:33.909,  0.296875,  -0.890625, -0.218750,  19.85\n'
        '2023-06-08 15:19:33.919,  0.421875,  -0.812500, -0.171875,  19.85\n'
        '2023-06-08 15:19:33.929,  0.375000,  -0.890625, -0.250000,  19.85\n'
        '2023-06-08 15:19:33.939,  0.359375,  -1.203125,  0.125000,  19.85'
...
def test_lowpass():
    ...
    data_ref = pd.read_csv(io.StringIO(
        'time,x,y,z,temperature\n'
        '2023-06-08 15:19:33.898,  0.379264, -0.783015, -0.253166,  19.85\n'
        '2023-06-08 15:19:33.909,  0.366240, -0.792810, -0.263782,  19.85\n'
        '2023-06-08 15:19:33.919,  0.368996, -0.837900, -0.225322,  19.85\n'
        '2023-06-08 15:19:33.929,  0.369180, -0.977334, -0.090964,  19.85\n'
        '2023-06-08 15:19:33.939,  0.359296, -1.203209,  0.125051,  19.85'
    ), parse_dates=['time'], index_col='time', dtype='f4')
...
def test_resample():
    ...
    data_ref = pd.read_csv(io.StringIO(
        'time,x,y,z,temperature\n'
        '2023-06-08 15:19:33.900,  0.375000, -0.765625, -0.218750,  19.85\n'
        '2023-06-08 15:19:33.910,  0.296875, -0.890625, -0.218750,  19.85\n'
        '2023-06-08 15:19:33.920,  0.421875, -0.812500, -0.171875,  19.85\n'
        '2023-06-08 15:19:33.930,  0.375000, -0.890625, -0.250000,  19.85\n'
        '2023-06-08 15:19:33.940,  0.359375, -1.203125,  0.125000,  19.85'
    ), parse_dates=['time'], index_col='time', dtype='f4')
